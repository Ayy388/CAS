...
if ($enroll.code -eq 200) {
    ...
    Write-Host "  鉁?Enrollment ID: $enrollmentId" -ForegroundColor Green
} else {
    Write-Host "  鉂?$($enroll.message)" -ForegroundColor Red
    $enrollmentId = $null
}
...
if ($enrollmentId) {
    ...
    if ($dropResp.code -eq 200) {
        Write-Host "  鉁?Dropped successfully" -ForegroundColor Green
    } else {
        Write-Host "  鉂?$($dropResp.message)" -ForegroundColor Red
    }
    ...
    if ($reEnroll.code -eq 200) {
        ...
        Write-Host "  鉁?Re-enrolled ID: $enrollmentId" -ForegroundColor Green
    } else {
        Write-Host "  鉂?$($reEnroll.message)" -ForegroundColor Red
    }
}
...
if ($reviewResp.code -eq 200) {
    Write-Host "  鉁?Approved" -ForegroundColor Green
} else {
    Write-Host "  鉂?$($reviewResp.message)" -ForegroundColor Red
}
